	...
	if ErrCheck(err) {
		...
		for index := 0; index < len(latestReleases.Items); index++ {
			...
			if ErrCheck(err) {
				...
				var relTypesAllowed = [...]string{"C64 Demo", "C64 One-File Demo", "C64 Intro", "C64 4K Intro", "C64 Crack Intro", "C64 Music", "C64 Music Collection", "C64 Graphics", "C64 Graphics Collection", "C64 Diskmag", "C64 1K Intro", "C64 Charts", "C64 Invitation", "C64 Fake Demo", "C64 256b Intro", "C64 Intro Collection"}
				found := false
