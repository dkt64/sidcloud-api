ssh -i "C:\Users\Bartosz Apanasewicz\.ssh\host1" root@185.157.81.123 /bin/bash -c 'rm -R /root/go/src/github.com/dkt64/sidcloud-api/dist'
...
ssh -i "C:\Users\Bartosz Apanasewicz\.ssh\host1" root@185.157.81.123 /bin/bash -c 'systemctl restart sidcloud'